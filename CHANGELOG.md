...
### Changed
- Switched Copilot CLI installation from Homebrew to npm (`npm install -g @github/copilot`)
- Removed Homebrew dependency for Copilot CLI — now only requires Node.js/npm
...
[0.7.1]: https://github.com/codetocloudorg/kodra-wsl/compare/v0.7.0...v0.7.1
